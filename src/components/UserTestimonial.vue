                    ...
                    <div class="w-full xl:w-1/2 xl:pr-8">
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                ...
                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Kehinde
                                    Bello</h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                        </blockquote>
                    ...
                    <div class="w-full xl:w-1/2 xl:pl-8">
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                ...
                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Itunuoluwa Smith </h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                        </blockquote>
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                ...
                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Usman
                                    Garba</h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                        </blockquote>
