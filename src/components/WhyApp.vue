<template>
    <div id="features" class="relative w-full px-8 py-10 border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            <h3 class="max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center sm:mt-0 sm:px-0 sm:text-6xl animate__animated animate__fadeInDown">
                Help Provide Insider Information for Job Seekers
            </h3>
            <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">

                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3 animate__animated animate__fadeInUp animate__delay-1s">
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3 animate__animated animate__fadeInUp animate__delay-2s">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Review</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">
                            Write and share your reviews on companies or businesses anonymously.
                        </p>
                    </div>
                </div>

                <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3 animate__animated animate__fadeInUp animate__delay-3s">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <p class="relative mt-2 text-base text-center text-gray-600">
                            Get insider information from people who have worked there.
                        </p>
                    </div>
                </div>
